classdef SatelliteImageRegistration < handle
    ...
    properties (Access = public)
        ...
        modus                  logical % Boolean to indicate a specific mode

    end

    %% =====             Constructor & high-level API              ===== %%
    methods
        function obj = SatelliteImageRegistration(imageFolder, app,modus)
            % Constructor
        ...
        function run(obj)
            ...
            assignin('base', 'registeredColorImages', obj.registeredColorImages);
            assignin('base', 'segbilder', obj.segmentedOverlapMasks);
    ...
    methods
        function loadImages(obj)
            obj.updateStatus('📂 Bilder werden geladen...');
            pause(1.5);
        ...
        function segmentImages(obj)
            obj.updateStatus('🧠 Segmentierung läuft...');
        ...
        function registerImages(obj)
            obj.updateStatus('🧭 Registrierung startet...');
            ...
            if obj.modus
                [obj.registeredColorImages, ...
                 obj.validIndices,          ...
                 obj.refIdx,                ...
                 obj.tformList] = Register_Color_Images_Fast( ...
        ...
        function applyTransformsToSegmentations(obj)
            obj.updateStatus('🔀 Überlagerung von Masken...');
